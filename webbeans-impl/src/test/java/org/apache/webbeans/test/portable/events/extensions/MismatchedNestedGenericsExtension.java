...
/**
 * Negative test extension using a concrete nested generic type
 * {@code MyClass<Foo<Bar<BazImpl>>>}. It should not be triggered for
 * {@link NestedGenericsTypeVariableExtension.OtherMyClassImpl}, which uses
 * {@code OtherBazImpl} instead of {@code BazImpl} in the deepest position.
 */
public class MismatchedNestedGenericsExtension implements Extension
{
